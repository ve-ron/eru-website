...
const CFooter = () => {
    return (
        <>
        <footer className="p-4 justify-between items-center bg-c_nav-pink-light sm:p-6 ">
            <div className="container md:flex flex-wrap justify-between items-center md:mx-auto ">
                <div className="mb-6 md:mb-0">
                    <Link to="/#" className="flex items-center">
                        <img src="https://cdn.discordapp.com/embed/avatars/1.png" className="mr-3 h-8 rounded-full" alt="eru bot." />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap text-c_normal-light hover:text-c_focus-light">Eru bot.</span>
                    </Link>
                    <span className="flex items-center text-c_normal-light">Invite eru bot today.</span>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 className="mb-6 text-base font-bold  uppercase text-c_focus-light">About</h2>
                    ...
                    <div>
                        <h2 className="mb-6 text-base font-bold  uppercase text-c_focus-light">Follow Us</h2>
                        <ul className="text-c_normal-light">
                            <li className="mb-4">
                                <Link to="/#" className="hover:underline ">Invite</Link>
                            </li>
                            <li className="mb-4">
                                <Link to="/#" className="hover:underline">Discord</Link>
                            </li>
                            <li>
                                <Link to="/#" className="hover:underline">Top.gg</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h2 className="mb-6 text-base font-bold  uppercase text-c_focus-light">Legal</h2>
                        <ul className="text-c_normal-light">
                            <li className="mb-4">
