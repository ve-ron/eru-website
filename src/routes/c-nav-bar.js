...
//    const [redirect, setRedirect] = useState(false);
   ...
   useEffect(()=> {
    ...
    const navigateTo = (e) => {
        ...
        // return (
        //     <Navigate to='/commands' replace={true}/>
        // )
                ...
                <div className={ 
                   navStatus?"justify-between items-center w-full md:flex md:w-auto md:order-1":"hidden justify-between items-center w-full md:flex md:w-auto md:order-1"
                    ...
                    <div className="relative mt-3 md:hidden">
                        ...
                        <input value={searchText} onChange={(e)=>{setSearchText(e.target.value)}} onKeyDown={(e)=>{navigateTo()}} type="text" id="search-navbar" className="block p-2 pl-10 w-full text-gray-900 bg-c_normal-light rounded-lg border border-gray-300 sm:text-sm focus:ring-pink-500 focus:border-pink-500 focus:outline-1 focus:outline-c_focus-light" placeholder="eru help"/>
                    </div>
