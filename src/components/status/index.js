                ...
                <div className="flex flex-col md:flex-row rounded-lg bg-gradient-to-r from-rose-300/75 via-purple-400/65 to-violet-200 md:mx-12 mx-2  justify-center">
                    ...
                    <div className=" md:self-end mb-10">
                        <div className=" text-base justify-center my-10">
                            ...
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 align-text-bottom inline-block text-green-600" viewBox="0 0 20 20" fill="currentColor"> <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                </svg> 
                            </span> 
                        ...
                        <div className=" text-base justify-center my-10">
                            ...
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 align-text-bottom inline-block text-slate-500" viewBox="0 0 20 20" fill="currentColor">
